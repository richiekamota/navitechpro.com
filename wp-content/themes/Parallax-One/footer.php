...
<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
	...
	?>
		...
		<?php echo apply_filters( 'parallax_one_plus_footer_text_filter', '<div class="powered-by"><a href="https://themeisle.com/themes/parallax-one/" target="_blank" rel="nofollow"> </a>' . esc_html__( '', '' ) . '<a class="" href="http://wordpress.org/" target="_blank" rel="nofollow">' . esc_html__( '', '' ) . '</a></div>' ); ?>
	</div><!-- container -->
</footer>
